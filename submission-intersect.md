...
Initializ a camera instance with the camera data in scenedata. Use intersect() as a helper function to detect the intersection between ray and each shape in the scene.
Compute hitpoints and normals for each shape in world space after having "t" values.
Compute different components for phong illumination. 

### Collaboration/References

### Known Bugs
Lose diffuse and specular components in directional_light scenes.a
